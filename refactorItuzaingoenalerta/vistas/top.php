...
<head>
    <title>
        <? echo $labels["TITULO"] . ($titulo ? " - " . $titulo : "") ?>
    </title>
...
<body>
    ...
    ga('create', '<? echo $system["GA_SEGUIMIENTO"] ?>', '<? echo $system["GA_URL"] ?>');
    ga('send', 'pageview');
    </script>
    <div>
            ...
            <div class="navbar-inner navbar-conf">
                ...
                <div class="nav-collapse in collapse" style="height: auto;">
                    <ul class="nav">
                        ...
                        <li <? echo $menu=="COMO" ? 'class="active"' : '' ; ?>>
                            <a href="ComoFunciona">
                                <i class="icon-question"></i> C&oacute;mo funciona </a>
                        </li>
                        ...
                        <li <? echo $menu=="Registrar" ? 'class="active"' : '' ; ?>>
                            <a href="Registrar"><i class="icon-group"></i> Registrar</a>
                        </li>
                        <? } ?>
                        ...
                        <li <? echo $menu=="USUARIOS" ? 'class="active"' : '' ; ?>>
                            <a href="Usuarios"><i class="icon-user"></i> Usuarios</a>
                        </li>
                        <? } ?>
                        ...
                        <li <? echo $menu=="CENTRALES" ? 'class="active"' : '' ; ?>>
                            <a href="Centrales"><i class="icon-phone"></i> Centrales</a>
                        </li>
                        <? } ?>
                        <? if ($usuario->tieneAcceso(Usuario::N_ADMIN . Usuario::N_ADMINGENERAL)) { ?>
                        <li <? echo $menu=="CONF" ? 'class="active"' : '' ; ?>>
                            <a href="Configuracion"><i class="icon-cogs"></i> Configuraci&oacute;n</a>
                        </li>
                        <? } ?>
                        <? if ($usuario->esVecino()) { ?>
                ...
                <div id="divUser" class="usuario">
                    ...
                    <div class="login">
                        ...
                        <button class="btn btn-small" onclick="location.href = '<? echo $system[" URL_LOGIN"];
                            ?>';">Login</button>
                    </div>
